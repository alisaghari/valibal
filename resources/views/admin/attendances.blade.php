    ...
    <div class="tbl-content">
        ...
        <table cellpadding="0" cellspacing="0" border="0">
            ...
            <tr>
                ...
                <td>{{$year}} - {{$mon}} - {{$day}} </td>
                <td><a onclick="per({{$year}},{{$mon}},{{$day}},{{$user->user_id}},{{$product_id}})" class="button2">حاضر</a></td>
                <td><a onclick="aps({{$year}},{{$mon}},{{$day}},{{$user->user_id}},{{$product_id}})" class="button">غایب</a></td>
            </tr>
            @endforeach
            </tbody>
        </table>
		<script>
            function per(year,mount,day,userid,productid) {
...
alert("حضور ثبت شد");
                ...
                xhttp.open("GET", "{{url("/")}}/attend/p/"+productid +"/"+userid+"/"+year+"-"+mount+"-"+day, true);
                xhttp.send();
            }
            function aps(year,mount,day,userid,productid) {
                var xhttp = new XMLHttpRequest();
                xhttp.onreadystatechange = function() {
                    if (this.readyState == 4 && this.status == 200) {
                   alert("غیبت ثبت شد");
                ...
                xhttp.open("GET", "{{url("/")}}/attend/a/"+productid +"/"+userid+"/"+year+"-"+mount+"-"+day, true);
                xhttp.send();
            }
		</script>
    </div>
