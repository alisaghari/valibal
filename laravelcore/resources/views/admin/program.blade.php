...
@section('content')
    ...
    {{ Form::open(array('url' => 'adminSecret/product/program/add/2', 'method' => 'post')) }}
    {{ Form::hidden('product_id',$id) }}
    <table class="table table-bordered">
        <tr>
            <th>روز</th>
    ...
    {{ Form::open(array('url' => 'adminSecret/product/program/add/3', 'method' => 'post')) }}
    {{ Form::hidden('product_id',$id) }}
    <table class="table table-bordered">
        <tr>
            <th>روز</th>
    ...
    {{ Form::open(array('url' => 'adminSecret/product/program/add/4', 'method' => 'post')) }}
    {{ Form::hidden('product_id',$id) }}
    <table class="table table-bordered">
        <tr>
            <th>روز</th>
